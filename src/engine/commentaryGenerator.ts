...
export function generateFullRaceCommentaryTimeline(
  ...
  // Tích hợp cốt truyện độc bản tương ứng
  ...
  // 2. Chèn Câu Cốt Truyện Điểm Nhấn (Storyline Hook)
  ...
  // 3. So kè sớm (BATTLE hoặc SLIPSTREAM)
  ...
  // 4. Tăng tốc phản lực Nitro (NITRO)
  ...
  // 5. Cú bẻ cua Drifting đỉnh cao (DRIFT)
  ...
  // 6. Cú vượt mặt thần sầu (OVERTAKE)
